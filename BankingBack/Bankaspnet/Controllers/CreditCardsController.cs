...
namespace BankingManagement.Controllers
{
    ...
    public class CreditCardsController : ControllerBase
    {
        ...
        public CreditCardsController(BankingManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CreditCard>> PostCreditCard(CreditCard creditCard)
        {
            ...
            {
                if (CreditCardExists(creditCard.Rib))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetCreditCard", new { id = creditCard.Rib }, creditCard);
        }
        ...
        {
            return _context.CreditCards.Any(e => e.Rib == id);
        }
    }
}
